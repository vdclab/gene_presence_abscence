...
rule psiblast:
    ...
    output:
        os.path.join(OUTPUT_FOLDER, 'processing_files', 'psiblast', f'psiblast--eval_{e_val_psiblast:.0e}_raw.out')
    log:
...
rule blast:
    ...
    output:
        ...
        fasta_for_blast = os.path.join(OUTPUT_FOLDER, 'databases', 'merge_fasta', 'all_protein_with_seeds.fasta')
    log:
