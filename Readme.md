...
```shell
snakedeploy deploy-workflow https://github.com/vdclab/sORTholog . --tag 0.6.0
```

else, run 

```shell
snakedeploy deploy-workflow https://github.com/vdclab/sORTholog path/to/sORTholog --tag 0.6.0
```
